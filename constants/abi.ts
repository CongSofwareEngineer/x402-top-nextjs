export const ABI_DEPOSIT_WALLET_FACTORY = [
  {
    inputs: [
      { internalType: 'address', name: '_beacon', type: 'address' },
      { internalType: 'address', name: '_legacyImpl', type: 'address' },
    ],
  ...
  { inputs: [], name: 'ImplementationNotAuthorized', type: 'error' },
  { inputs: [], name: 'ImplementationNotDeployed', type: 'error' },
  { inputs: [], name: 'InvalidInitialization', type: 'error' },
  { inputs: [], name: 'InvalidTimelockDelay', type: 'error' },
  { inputs: [], name: 'NewOwnerIsZeroAddress', type: 'error' },
  { inputs: [], name: 'NoHandoverRequest', type: 'error' },
  { inputs: [], name: 'NotInitializing', type: 'error' },
  { inputs: [], name: 'OnlyAdmin', type: 'error' },
  { inputs: [], name: 'OnlyLegacyDeployer', type: 'error' },
  ...
  },
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'implementation', type: 'address' }],
    name: 'ImplementationUnauthorized',
    type: 'event',
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'timelockDelay', type: 'uint256' }],
  ...
  { inputs: [], name: 'LEGACY_IMPL', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  {
    inputs: [],
  ...
  {
    inputs: [{ internalType: 'address', name: '_legacyDeployer', type: 'address' }],
    name: 'addLegacyDeployer',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'predictLegacyWalletAddress',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  { inputs: [], name: 'timelockDelay', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_implementation', type: 'address' }],
    name: 'unauthorizeImplementation',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
